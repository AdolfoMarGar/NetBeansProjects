...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void crearTabla(){     
        ...
        for(int i=0;i<lista.size();i++){
            System.out.println("Num matri: "+lista.get(i).getNum_mat());
    ...
    private void borrarDatos(int pos_fichero,int pos_lista) {
        try {
            ...
            fichero.seek(pos_fichero*12);
            System.out.println("num: "+fichero.readInt());
        ...
        try{
            ...
            if(num>0){
                if(lista.isEmpty()) {
                    ...
                    if(filtro){
                        System.out.println("ENcontrado en pos: "+aux);
                        System.out.println("nºmat: "+lista.get(aux).getNum_mat());
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addComponent(txt_numBorrar, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
