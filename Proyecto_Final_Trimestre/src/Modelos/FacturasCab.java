...
public class FacturasCab  implements java.io.Serializable {
    ...
    public FacturasCab(long numfac, Clientes clientes, Date fechafac) {
        this.numfac = numfac;
    ...
    public String toString() {
        return "FacturasCab{" + "numfac=" + numfac + ", clientes=" + clientes + ", fechafac=" + fechafac + ", facturasTot=" + facturasTot + '}';
    }
    ...
    public void addFacturasLins(FacturasLin factura){
        this.facturasLins.add(factura);
    }
    
    public ArrayList getListFacturasLins(){
        ArrayList<FacturasLin> lista = new ArrayList<>(this.facturasLins);
        return lista;
    }
