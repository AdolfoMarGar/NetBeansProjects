...
public class EstadisticasClientes  implements java.io.Serializable {
    ...
    public String toString() {
        return "EstadisticasClientes{" + "id=" + id + ", clientes=" + clientes + ", mesNom=" + mesNom + ", nombrecli=" + nombrecli + ", sumaBase=" + sumaBase + ", sumaDtos=" + sumaDtos + ", sumaIva=" + sumaIva + ", sumaTotales=" + sumaTotales + '}';
    }
