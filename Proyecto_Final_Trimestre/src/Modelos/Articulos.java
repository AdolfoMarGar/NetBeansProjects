...
public class Articulos  implements java.io.Serializable {
    ...
    public String toString() {
        return "Articulos{" + "referencia=" + referencia + ", descripcion=" + descripcion + ", precio=" + precio + ", porciva=" + porciva + ", stock=" + stock + '}';
    }
    ...
    public void addFacturasLins(FacturasLin facturalin){
        this.facturasLins.add(facturalin);
    }
