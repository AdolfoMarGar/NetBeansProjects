...
public class Util {
    ...
    public static void operacion_realizada(){
        JOptionPane.showMessageDialog(new JFrame(), "Operación realizada sin problemas.", "Operación finalizada", JOptionPane.INFORMATION_MESSAGE);
    }
